 ...
 */
#ifndef DYNAMIC_VINO_LIB_INFERENCES_OBJECT_DETECTION_RESULT_H
#define DYNAMIC_VINO_LIB_INFERENCES_OBJECT_DETECTION_RESULT_H
#include <memory>
#include <vector>
#include <string>
#include <map>
...
#endif  // DYNAMIC_VINO_LIB_INFERENCES_OBJECT_DETECTION_RESULT_H
