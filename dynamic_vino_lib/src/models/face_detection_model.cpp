...
Models::FaceDetectionModel::FaceDetectionModel() : BaseModel()
{
}
...
void Models::FaceDetectionModel::adjustBoundingBox(cv::Rect& boundingBox) 
{
...
bool Models::FaceDetectionModel::updateLayerProperty(const InferenceEngine::CNNNetReader::Ptr net_reader)
{
