...
Models::AgeGenderDetectionModel::AgeGenderDetectionModel() : BaseModel()
{
}

// void Models::AgeGenderDetectionModel::setModel(const std::string& model_loc, int max_batch_size)
// {
// }
